...
const Trending = (props) => {
  ...
  useEffect(() => {
    ...
    fetchMeals(requests.fetchTrending);
  }, []);
  ...
  const dataList = trending.filter(
    (img) => srcURL === `https://image.tmdb.org/t/p/original${img.poster_path}`
  );

  return (
    <div className="container-fluid ">
      <div className="text-white fw-bold h5 mt-3">Trending</div>
      <div
